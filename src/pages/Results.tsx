  ...
  useEffect(() => {
    ...
    const checkStatus = async () => {
      try {
        ...
        // Using type assertion since database tables aren't created via migration yet
    ...
    const fetchResults = async () => {
      try {
        ...
        setPositioning(posData as unknown as ProductPositioning);
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-foreground">{positioning.positioning_data.core_messaging.value_proposition}</p>
                    </div>
                    <div>
                      <h5 className="text-sm font-medium text-muted-foreground mb-2">Key Differentiators</h5>
                      <ul className="list-disc list-inside space-y-1">
                        {positioning.positioning_data.core_messaging.key_differentiators.map((diff, i) => (
